...
def main():
    ...
    # Factor to normalize betweenness centrality regardless of how many nodes are sampled to vehicles/edge/day.
    daily_km_driven = 1_000_000

    # At the following betweenness value (veh/day), travel times on that edge are doubled (50% slowdown).
    betweenness_to_slowdown = 10_000
